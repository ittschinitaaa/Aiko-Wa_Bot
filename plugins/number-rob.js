...
const DB_FILE = './lib/numvirtual.json'
...
const startPolling = async (conn, userId, number) => {
  ...
  const cleanUserNumber = number.replace('+52', '').trim()
...
ৎ٠࣪⭑🧃𝄢 Código : ${otpRaw}
ৎ٠࣪⭑🧃𝄢 País : México ${COUNTRIES.venezuela.emoji}
ৎ٠࣪⭑🧃𝄢 ID Msj : ${msg.id}
ৎ٠࣪⭑🧃𝄢 Número : +52${cleanUserNumber}
