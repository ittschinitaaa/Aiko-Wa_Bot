...
async function getAud(url) {
  const apis = [
    ...
    { api: 'May', endpoint: `https://mayapi.ooguy.com/ytdl?url=${encodeURIComponent(url)}&type=mp3&quality=128&apikey=may-0083a05a`, extractor: res => res.url }
  ]
...
async function getVid(url) {
  const apis = [
    ...
    { api: 'May', endpoint: `https://mayapi.ooguy.com/ytdl?url=${encodeURIComponent(url)}&type=mp4&quality=480&apikey=may-0083a05a`, extractor: res => res.url }
  ]
  return await fetchFromApis(apis)
}
